          ...
          child: Column(
            children:[
              ...
              style: TextStyle(
                ...
                fontSize: 20)),
              Padding(
                padding: EdgeInsets.only(right: size.width*0.3, top:size.width*0.03)),
              Stack(
                children: [
                  Padding(
                    padding: EdgeInsets.only(right: size.width*0.2, top:size.width*0.03),
                    child: SizedBox(
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: size.width*0.5, bottom: size.width*0.02,),
                    child: ClipRRect(
